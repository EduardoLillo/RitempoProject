	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
           ...
           <div class="form-group">
            	...
            	<br>
            	     {{ Form::textarea('descripcion',$categoria->descripcion,['class'=>'form-control ckeditor'],null) }}

            	<!--<textarea name="descripcion" cols="10" rows="10" class="form-control" maxlength="500" value="{{$categoria->descripcion}} placeholder="Descripción..."></textarea>
